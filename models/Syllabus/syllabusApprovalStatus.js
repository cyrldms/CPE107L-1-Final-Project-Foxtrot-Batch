...
const syllabusApprovalStatusSchema = new Schema({
  ...
  status: { 
    type: String, 
    enum: ["Approved", "Pending Endorsement", "Pending", "Not Submitted", "Archived", "Endorsed", "Returned to PC", "Rejected", "Returned to Dean", "Pending Faculty Signature", "Signed by Faculty", "Draft"], 
